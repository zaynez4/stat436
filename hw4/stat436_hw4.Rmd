...
This visualization was NOT included in my final write up because I kept it to 2 static visualizations as outlined in the rubric. I wished to keep it included because it is similar to the visualization above but it shows a more heatmap version and outlines topic membership per episode more explicitly.

```{r}
# the chunk below is used to sort the documents based on hierarchical
# clustering
gamma = memberships %>%
...
# create the structure plot to show a more colored distribution of
# the membership compared to the box plots above
ggplot(memberships, aes(gamma, document, fill = topic, col = topic)) +
  ...
  labs(title = "Structure Plot for each Season's Topic Membership",
       x = "Membership Proportion",
       y = "Episode",
       fill = "Topic",
       col = "Topic")
```
