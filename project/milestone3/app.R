...
scatterplot = function(rate_covid_data) {
  ggplot(rate_covid_data, aes(cases, rate, col=continent)) +
    ...
    labs(title = "Comparative Plot of COVID-19 Case and Inflation Rate",
      ...
      tabPanel("The Effect of COVID-19",
               sidebarLayout(
                 sidebarPanel(
                   ...
                   p("The only inflation type used is Headline Consumer Price Inflation because that is the total inflation rate in the economy.
               ...
               p("The x-axis in labeled in scientific notation, so 1e04 means 10,000, 1e5 means 100,000, etc."),
